...
echo "<ul id=\"user-status\">";
    echo "<li class=\"pic\"><a href=\"index.php?option=com_admin&amp;task=profile.edit\"><img id=\"gravatar\" src=\"http://www.gravatar.com/avatar/$gravatar_hash?d=mm&s=30\" alt=\"$user->name\" /></a></li>";
