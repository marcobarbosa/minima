...
window.addEvent('domready', function() {
    ...
    if(bulkActions.length)
    {
        ...
        //$$('.toolbar-list').setStyle('display', 'block');
    ...
    if (systemMessage)
    {
        ...
        systemMessage.getElement("ul li:last-child").adopt(hideAnchor);
    }
    ...
    if ($('filter-bar'))
    {
        //var bar = $('filter-bar') != null ? $('filter-bar') : $$('.filter');
        var bar = $('filter-bar').hide();
